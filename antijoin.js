...
client.on('message',async message => {
  ...
  if(args[2]) {
    ...
    if(mention.id === message.author.id) return message.channel.send('**:heavy_multiplication_x:| You cant transfer credit to your self **');
    if(credits[author].credits < balance) return message.channel.send('**:heavy_multiplication_x:| You dont have enough credits **');
