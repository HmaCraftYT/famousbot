...
client.on('message', message => {
    if (message.content.toLowerCase() === prefix + "help") {
        ...
        message.channel.send("** Your message has been sent📬 ** ")
            let embed = new Discord.RichEmbed()
        .addField("${perfix}new",' open a new ticket ')
        .addField("${perfix}clear", 'clear the chat  ')
        .addField("${perfix}bot",' bot information ')
        .addField("${perfix}id",' your information ')
        .addField("${perfix}kick",' to kick someone ')
        .addField("${perfix}ban",' to ban someone ')
        .addField("${perfix}mute",' to mute someone ')
        .addField("${perfix}unmute",' to unmute someone ')
	.addField("${perfix}server",' server information ')
	.addField("${perfix}members",' members status ')
	.addField("${perfix}setstats",' date ,time and voice online ') 
	.addField("${perfix}setuser",' member count ')
	.addField("${perfix}giveaway",' to make a giveaway ') 
	.addField("${perfix}buck",' to know your balance ')
	.addField("${perfix}invite",' to invite the bot to your server ')
	.addField("${perfix}daily",' to get your daily reward ')
	.addField("${perfix}ct",' to mack a text channel ')
	.addField("${perfix}cv",' to make a voice channel ')
        .setColor('RANDOM')
